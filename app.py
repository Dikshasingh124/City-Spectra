...
users = {
    'user1': generate_password_hash('userpass'),
    'user2': generate_password_hash('12345')
}
...
# Data loading and plot functions
...
def city_analysis(city_name):
    ...
    return render_template(
        'city_analysis.html', city_name=city_name,
        recommendations=recommendations, budget=budget,
